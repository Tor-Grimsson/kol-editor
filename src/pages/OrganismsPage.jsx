      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <section className="space-y-8">
          <div>
            ...
            <p className="text-fg-64 mb-6">Major sections - complete UI sections composed of molecules and atoms</p>
          </div>
          ...
          <div className="border border-fg-08 rounded-lg p-6 bg-surface-primary/50">
            <div className="mb-4">
              ...
              <p className="text-sm text-fg-64">Navigation bar with canvas size, clear, and load buttons</p>
            </div>
          ...
          <div className="border border-fg-08 rounded-lg p-6 bg-surface-primary/50">
            <div className="mb-4">
              ...
              <p className="text-sm text-fg-64">Tool buttons with dropdowns and filter menu</p>
            </div>
          ...
          <div className="border border-fg-08 rounded-lg p-6 bg-surface-primary/50">
            <div className="mb-4">
              ...
              <p className="text-sm text-fg-64">Full layer/canvas management sidebar</p>
            </div>

            <div className="border border-fg-08 rounded overflow-hidden max-w-xs">
              <LayersSidebar
                layers={mockLayers}
          ...
          <div className="border border-fg-08 rounded-lg p-6 bg-surface-primary/50">
            <div className="mb-4">
              ...
              <p className="text-sm text-fg-64">Property inspector with color picker and controls</p>
            </div>

            <div className="border border-fg-08 rounded overflow-hidden max-w-sm">
              <Inspector
          ...
          <div className="border border-fg-08 rounded-lg p-6 bg-surface-primary/50">
            <div className="mb-4">
              ...
              <p className="text-sm text-fg-64">Main canvas with rulers, stage, artboard, and handles</p>
            </div>

            <div className="bg-container-primary/50 rounded p-6 text-center">
              <p className="text-fg-48">
                CanvasArea requires Konva Stage and complex state management.
              </p>
              <p className="text-sm text-fg-32 mt-2">
        ...
        <div className="border-t border-fg-08 pt-6 pb-12">
          <p className="text-sm text-fg-48">
            Component library structure: <Link to="/components/atoms" className="text-fg-64">Atoms</Link> → <Link to="/components/molecules" className="text-fg-64">Molecules</Link> → <Link to="/components/organisms" className="text-green-400">Organisms</Link>
          </p>
        </div>
      </div>
    </div>
