    ...
    switch (control.type) {
      case 'slider':
        return (
          <div
            key={control.id}
            className="control-slider-minimal w-full"
            style={{
              display: 'grid',
      ...
      case 'toggle-button':
        return (
          <div
            key={control.id}
            className="kol-mono-xs control-slider-minimal gap-3"
          >
            {control.label}
            {' '}
            <span
      ...
      case 'button':
        return (
          <div
            key={control.id}
            className="kol-mono-xs control-slider-minimal gap-3 cursor-pointer"
